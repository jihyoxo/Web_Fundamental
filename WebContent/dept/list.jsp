...
<%
	...
	if(cPage>totalPage){
		response.sendRedirect("list.jsp?page=1");	//실제페이지값보다 많으면 첫번째 페이지 링크로 이동.
		return;
	}
	...
	startPage	endPage
		...
		endPage = 10 + (currentBlock-1) * pageLength
	...
	<div class="row">
		<div class="col-lg-12">
			...
			<table class="table table-hover">
				...
				<%}else{ %>
				<tr>
					<td clospan="3">데이터가 존재하지 않습니다.</td>
				</tr>
				<%}%>
			...
			<nav aria-label="Page navigation example">
				<ul class="pagination justify-content-center">
					...
					<li class="page-item disabled">
						<a class="page-link" href="#" tabindex="-1" aria-disabled="true">Previous</a></li><li>
					</li>
					<%}else{ %>
					<li class="page-item ">
			...
			<div class="text-right">
				<a href="write.jsp?page=<%=cPage %>" class="btn btn-outline-success">부서등록</a>
			</div>
